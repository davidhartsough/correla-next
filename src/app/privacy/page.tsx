...
export default function Privacy() {
  return (
    <article id="privacy-policy" className="mb-8">
      ...
      <p>We may collect personal identification information, including your:</p>
      <ul>
        <li>Name</li>
        <li>Email address</li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Notifications</strong>: You may opt in to receive informative
          notification emails that assist in the functionality of the
          application&#39;s services.
        </li>
        <li>
          <strong>Updates</strong>: You may opt in to receive email updates on
          key changes to the application&#39;s services, including new features
          and functionality.
        </li>
        <li>
          <strong>Requests</strong>: If you email us a request and provide us
          with consent, then we may use your email to assist you with fulfilling
          your request, such as retrieving or deleting your account and its
          data.
        </li>
      </ul>
      <h2 id="how-we-store-it">How we store it</h2>
      <p>We securely store your data in databases located in Portland, USA.</p>
      ...
      <p>
        ...
        the webmasters as anonymized, serialized, and otherwise encrypted data.
        Anyone with this access is subject to strict contractual and legal
      ...
      <p>
        You may manage your data either directly from the website application or
        by emailing us your request.
      </p>
      <p>
        Within the application you may update or delete any account data you
        wish at any time, including the option to completely delete your entire
      ...
      <p>Every user is entitled to the following data protection rights to:</p>
      <ul>
        <li>
        ...
        <li>
          ...
          right to request for us to help you complete the information you
          believe is incomplete.
        </li>
        <li>
          <strong>Erasure</strong>: You have the right to request that we erase
        ...
        <li>
          <strong>Object to processing</strong>: You have the right to object to
      ...
      <p>
        ...
        applies only to our website, so if you click on a link and go to another
        website, you should read their privacy policy. These external sites are
      ...
      <p>
        ...
        this web page. We may update our Privacy Policy from time to time.
